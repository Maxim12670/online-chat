<template>
  <svg style="display: none;">
    ...
    <symbol id="message-icon" viewBox="0 0 24 24" fill="none">
      <g id="SVGRepo_iconCarrier">
        <path
          ...
          stroke="#000000" stroke-width="0.744" stroke-linecap="round" stroke-linejoin="round" />
      </g>
    ...
    <symbol id="friends-icon" viewBox="0 0 16.00 16.00" fill="none" stroke="#000000" stroke-linecap="round"
      stroke-linejoin="round" stroke-width="0.608">
      <g>
