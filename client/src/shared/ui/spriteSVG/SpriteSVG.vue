<template>
  <svg style="display: none;">
    ...
    <symbol id="friends-icon" viewBox="0 0 16.00 16.00" fill="none" stroke-linecap="round" stroke-linejoin="round"
      stroke-width="0.758">
      <g>
    ...
    <symbol id="basket-icon" viewBox="0 0 256 256">
    ...
    <symbol id="absence-icon" viewBox="0 0 512.000000 512.000000">
      <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
        <path
          d="M862 4593 c-60 -21 -144 -102 -173 -165 -21 -47 -24 -71 -27 -225 l-4 -171 -59 -11 c-112 -19 -199 -85 -251 -190 l-23 -46 0 -1515 0 -1515 27 -57 c31 -66 91 -128 156 -160 l47 -23 2005 0 2005 0 47 23 c65 32 125 94 156 160 l27 57 0 1595 0 1595 -24 48 c-34 69 -101 132 -166 156 -55 21 -72 21 -818 21 -724 0 -764 1 -802 19 -24 12 -106 86 -210 191 -136 138 -182 178 -230 201 l-60 29 -790 -1 c-678 0 -796 -3 -833 -16z m1610 -152 c13 -5 111 -94 218 -198 135 -131 209 -195 240 -208 43 -19 79 -20 832 -25 776 -5 787 -5 815 -26 57 -42 63 -69 63 -286 l0 -197 -47 22 c-48 22 -49 22 -898 27 -700 4 -854 7 -875 19 -14 8 -117 105 -230 216 -169 166 -214 205 -255 221 -47 18 -91 19 -782 22 l-733 3 0 147 c0 169 14 216 72 252 32 20 49 20 795 20 437 0 772 -4 785 -9z m-207 -582 c32 -9 79 -49 245 -214 121 -119 223 -212 250 -226 l45 -24 855 -5 c771 -5 858 -7 885 -22 39 -21 71 -56 84 -91 8 -20 11 -410 11 -1255 l0 -1227 -23 -39 c-12 -22 -35 -49 -50 -60 l-28 -21 -1965 -3 c-2171 -2 -2006 -7 -2060 64 l-29 37 -3 1471 c-2 978 1 1483 7 1506 13 45 65 95 111 108 51 15 1613 15 1665 1z" />
        <path
          d="M2375 2916 c-332 -66 -614 -322 -713 -647 -135 -442 103 -954 528 -1134 134 -57 199 -69 365 -70 125 0 164 4 234 23 531 144 830 692 660 1207 -41 124 -109 234 -204 334 -128 134 -258 213 -442 267 -110 32 -316 42 -428 20z m410 -173 c210 -69 367 -206 465 -408 72 -149 98 -292 80 -439 -32 -262 -192 -481 -435 -597 -104 -50 -178 -69 -295 -76 -334 -20 -649 185 -767 498 -76 202 -64 405 37 614 58 119 133 213 226 283 102 76 179 111 329 146 11 3 83 3 160 1 104 -2 156 -8 200 -22z" />
        <path
          d="M2501 2544 c-20 -26 -21 -38 -21 -356 l0 -329 25 -24 c15 -16 36 -25 55 -25 19 0 40 9 55 25 l25 24 0 329 c0 318 -1 330 -21 356 -16 20 -29 26 -59 26 -30 0 -43 -6 -59 -26z" />
        <path
          d="M2511 1686 c-28 -16 -50 -52 -51 -84 0 -31 26 -79 49 -92 25 -13 77 -13 102 0 22 12 49 61 49 89 0 75 -83 124 -149 87z" />
      </g>
    </symbol>

    <symbol id="go-out-icon" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
      <g>
        <path
          d="M512,256C512,114.609,397.391,0,256,0S0,114.609,0,256s114.609,256,256,256S512,397.391,512,256z M40,256 c0-119.297,96.703-216,216-216s216,96.703,216,216s-96.703,216-216,216S40,375.297,40,256z" />
        <path transform="translate(256 256) rotate(-90) translate(-256 -256)"
          d="M363.312,299.312c6.25-6.25,6.25-16.375,0-22.625l-96-96c-6.25-6.25-16.375-6.25-22.625,0l-96,96 C145.562,279.812,144,283.906,144,288s1.562,8.188,4.688,11.312c6.25,6.25,16.375,6.25,22.625,0L256,214.625l84.688,84.688 C346.938,305.562,357.062,305.562,363.312,299.312z" />
      </g>
    </symbol>

    <symbol id="send-message-icon" viewBox="0 0 256 256">
    ...
    <symbol id="logout-account-icon" viewBox="0 0 256 256">
      <g style="stroke: none; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10;  fill-rule: nonzero; opacity: 1;"
        transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
        <path
